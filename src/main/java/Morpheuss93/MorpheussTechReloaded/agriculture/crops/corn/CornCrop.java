 ...
 */
public class CornCrop extends CropBase {

    public CornCrop(){
        super();
        this.setBlockName("CornCrop");
        theSeed= AgricultureHandler.corn;
    }
    ...
    public Item getItemDropped(int parMetadata, Random parRand, int parFortune)  {
        ...
        return AgricultureHandler.corncob;
    }
    ...
    public void double_c(World world,int x,int y,int z){
        ...
        if(meta>=7){
            if(world.getBlock(x, y+1, z)==Blocks.air){
                ...
                world.setBlock(x, y+1, z, AgricultureHandler.cornUp);
            }
        }
    }
