...
public class ContainerFishTrap extends Container{
    ...
    public ContainerFishTrap(InventoryPlayer player, TileEntityFishTrap tileEntityFurnace) {
        this.tileFurnace=tileEntityFurnace;
        //this.addSlotToContainer(new Slot(tileEntityFurnace,0,56,17));//position of slot
        this.addSlotToContainer(new Slot(tileEntityFurnace,0,24,32));//mais
        this.addSlotToContainer(new Slot(tileEntityFurnace, 1, 57, 33));
        this.addSlotToContainer(new SlotFurnace(player.player,tileEntityFurnace,2,116,35));//risultato
        int i;
